...
if is_available "telescope.nvim" then
  ...
  maps.n["<leader>w"] = { function() require("telescope.builtin").buffers() end, desc = "Find buffers" }
  maps.n["<leader>fc"] =
    { function() require("telescope.builtin").grep_string() end, desc = "Find for word under cursor" }
  maps.n["<leader>fC"] = { function() require("telescope.builtin").commands() end, desc = "Find commands" }
  maps.n["<leader>e"] = { function() require("telescope.builtin").find_files() end, desc = "Find files" }
  maps.n["<leader>fF"] = {
...
if is_available "harpoon" then
  ...
  maps.n["<leader>h"] = sections.h
  maps.n["<leader>ha"] = { function() harpoon:list():append() end, desc = "Add File to Harpoon" }
  maps.n["<leader>he"] = { function() harpoon.ui:toggle_quick_menu(harpoon:list()) end, desc = "Open Harpoon UI" }
  maps.n["<leader>hh"] = { function() harpoon:list():select(1) end, desc = "Select Harpoon file" }
  maps.n["<leader>hj"] = { function() harpoon:list():select(2) end, desc = "Select Harpoon file" }
  maps.n["<leader>hk"] = { function() harpoon:list():select(3) end, desc = "Select Harpoon file" }
  maps.n["<leader>hl"] = { function() harpoon:list():select(4) end, desc = "Select Harpoon file" }
...
if is_available "toggleterm.nvim" then
  ...
  if vim.fn.executable "cbonsai" == 1 then -- Create a lil bonsai tree to the side
    maps.n["<leader>tt"] = {
      function() utils.toggle_term_cmd { cmd = "cbonsai -l -i -w 1 -M 4", direction = "vertical", size = 70 } end,
      desc = "ToggleTerm grow a lil bonsai tree",
    }
  end
